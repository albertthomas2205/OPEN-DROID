"""
Django settings for asgi_uk_medical_bot project.
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://localhost",
    "http://localhost:3000",
    "https://unruminating-wally-placid.ngrok-free.dev", 
]
...
ROOT_URLCONF = 'asgi_uk_medical_bot.urls'
...
WSGI_APPLICATION = 'asgi_uk_medical_bot.wsgi.application'
ASGI_APPLICATION = 'asgi_uk_medical_bot.asgi.application'
...
CELERY_BEAT_SCHEDULE = {
    ...
    # new: run at 1:00 AM daily
    'reset-completed-time-daily': {
        'task': 'schedule_rounds.tasks.reset_completed_time',
        'schedule': crontab(hour=1, minute=0),   # every day at 1 AM
    },

    'clear-log-file-monthly': {
        'task': 'mainapp.tasks.clear_log_file',
        'schedule': crontab(hour=1, minute=0, day_of_month=1),  # 1 AM, 1st day of month
    },
