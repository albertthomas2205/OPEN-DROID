...
from .views import create_or_update_room, view_all_rooms, create_or_update_bed, view_all_bed, \
            create_slot, view_all_slot, soft_deactive_slot,soft_delete_slot,view_not_booked_slot, view_active_slot, create_slot_position,create_room_position_view, \
...
urlpatterns = [
    ...
    path('slot/not_booked/', view_all_slot, name='slot all'),
    path('slot/active/', view_active_slot, name='active slots'),
    path('slot/deactivate/<int:slot_id>/', soft_deactive_slot, name='soft delete slot'),
