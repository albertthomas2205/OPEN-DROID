...
urlpatterns = [
    ...
    path('deactivate-admin/<int:user_id>/', soft_deactivate_admin_user, name='view every admin data'),
    ...
    path('deactivate-patient/<int:patient_id>/', soft_deactive_patient, name='deactive patient data'),
    path('delete-patient/<int:patient_id>/', soft_delete_patient, name='delete patient data'),
    path('patients/deleted/', get_deleted_patients, name='get_deleted_patients'),
